...
public class RedisOperatorImpl implements RedisOperator{
    ...
    private static Logger logger = LoggerFactory.getServerErrorLogger(RedisOperatorImpl.class);
	...
	public void set(String key, String value, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call set(key="+key+", value="+value+", db="+db+") exception: "+e.toString(),e);
	...
	public Long incr(String key, long integer, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call incr(key="+key+", index="+integer+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call incr(key="+key+", index="+integer+", db="+db+") exception: "+e.toString(),e);
	...
	public String setex(String key, int seconds, String value, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call setex(key="+key+", time="+seconds+", value="+value+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call setex(key="+key+", time="+seconds+", value="+value+", db="+db+") exception: "+e.toString(),e);
	...
	public String getset(String key, String value, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call getset(key=" + key + ", value="+value+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call setex(key="+key + ", value="+value+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}finally{
			if(flag)
				builder.returnResource(jedis);
	...
	public Long expire(String key, int seconds, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call expire(key="+key+", time="+seconds + ", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}finally{
			if(flag)
				builder.returnResource(jedis);
	...
	public void lpush(String key, String value, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call lpush(key="+key+", value="+value+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call lpush(key="+key+", value="+value+", db="+db+") exception: "+e.toString(),e);
	...
	public List<String> rrange(String key, long start, long end, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call rrange(key="+key+", start="+start+", end="+end+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call rrange(key="+key+", start="+start+", end="+end+", db="+db+") exception: "+e.toString(),e);
	...
	public void ltrim(String key, long start, long end, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call ltrim(key="+key+", start="+start+", end="+end+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call ltrim(key="+key+", start="+start+", end="+end+", db="+db+") exception: "+e.toString(),e);
	...
	public Long rpush(String key, int db, String ... strings){
		...
		try{
			...
			flag = false;
			logger.error("redis call rpush(key="+key+", db="+db+", values="+ strings +") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call rpush(key="+key+", db="+db+", values="+ strings +") exception: "+e.toString(),e);
	...
	public Long hset(String key ,String field,String value,int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call hset(key="+key+", field="+field+", value="+value+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call hset(key="+key+", field="+field+", value="+value+", db="+db+") exception: "+e.toString(),e);
	...
	public Long hdel(String key,String field ,int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call hdel(key="+key+", field="+field+"db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call hdel(key="+key+", field="+field+"db="+db+") exception: "+e.toString(),e);
	...
	public String hget(String key,String field ,int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call hget(key="+key+", field="+field+"db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call hget(key="+key+", field="+field+"db="+db+") exception: "+e.toString(),e);
	...
	public Long hincrBy(String key, String field, long value, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call hincrBy(key="+key+", field="+field+"db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call hincrBy(key="+key+", field="+field+"db="+db+") exception: "+e.toString(),e);
	...
	public List<String> hmget(String key, int db, String ... fields){
		...
		try{
			...
			flag = false;
			logger.error("redis call hmget(key="+key+", field="+fields+"db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call hmget(key="+key+", field="+fields+"db="+db+") exception: "+e.toString(),e);
	...
	public String hmset(String key, int db,  Map<String, String> kvals){
		...
		try{
			...
			flag = false;
			logger.error("redis call hmset(key="+key+", kvals="+kvals+"db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call hmset(key="+key+", kvals="+kvals+"db="+db+") exception: "+e.toString(),e);
	...
	public boolean sismember(String key, String member, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call sismember(key="+key+", db="+db+ ", member=" + member + ") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call sismember(key="+key+", db="+db +", member=" + member + ") exception: "+e.toString(),e);
	...
	public void zadd(String key, double score, String member, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zadd(key="+key+", score="+score+", member="+member+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zadd(key="+key+", score="+score+", member="+member+", db="+db+") exception: "+e.toString(),e);
	...
	public Set<String> zrangeByScore(String key, double min, double max, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zrangeByScore(key="+key+", min="+min+", max="+max+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zrangeByScore(key="+key+", min="+min+", max="+max+", db="+db+") exception: "+e.toString(),e);
	...
	public Set<Tuple> zrangeByScoreWithScores(String key, double min, double max, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zrangeByScoreWithScores(key="+key+", min="+min+", max="+max+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zrangeByScoreWithScores(key="+key+", min="+min+", max="+max+", db="+db+") exception: "+e.toString(),e);
	...
	public Set<Tuple> zrevrangeByScoreWithScores(final String key,
		...
		try{
			...
			flag = false;
			logger.error("redis call zrevrangeByScoreWithScores(key="+key+", min="+min+", max="+max+", offset="+offset+", count="+count+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zrevrangeByScoreWithScores(key="+key+", min="+min+", max="+max+", offset="+offset+", count="+count+", db="+db+") exception: "+e.toString(),e);
	...
	public Set<String> zrangeByScore(String key, double min, double max,int offset, int count, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zrangeByScore(key="+key+", min="+min+", max="+max+", offset="+offset+", count="+count+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zrangeByScore(key="+key+", min="+min+", max="+max+", offset="+offset+", count="+count+", db="+db+") exception: "+e.toString(),e);
	...
	public Double zscore(String key, String member, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zscore(key="+key+", member="+member+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zscore(key="+key+", member="+member+", db="+db+") exception: "+e.toString(),e);
	...
	public Long zrem(String key, String member, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zrem(key="+key+", member="+member+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zrem(key="+key+", member="+member+", db="+db+") exception: "+e.toString(),e);
	...
	public Set<String> zrevrange(String key, long start, long end, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zrevrange(key="+key+", start="+start+", end="+end+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zrevrange(key="+key+", start="+start+", end="+end+", db="+db+") exception: "+e.toString(),e);
	...
	public Set<String> zrevrangeByScore(String key, double min, double max, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zrevrangeByScore(key="+key+", min="+min+", max="+max+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zrevrangeByScore(key="+key+", min="+min+", max="+max+", db="+db+") exception: "+e.toString(),e);
	...
	public Set<String> zrevrangeByScore(String key, double max, double min, int offset, int count, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zrevrangeByScore(key="+key+", min="+min+", max="+max+", offset="+offset+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zrevrangeByScore(key="+key+", min="+min+", max="+max+", db="+db+") exception: "+e.toString(),e);
	...
	public Long zcount(String key, double min, double max, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zcount(key="+key+", min="+min+", max="+max+",db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zcount(key="+key+", min="+min+", max="+max+",db="+db+") exception: "+e.toString(),e);
	...
	public Long zremrangeByScore(String key, double start, double end, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zremrangeByScore(key="+key+", start="+start+", end="+end+",db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zremrangeByScore(key="+key+", start="+start+", end="+end+",db="+db+") exception: "+e.toString(),e);
	...
	public Double zincrby(String key, double score, String member, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zincrby(key="+key+", score="+score+", member="+member+",db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zincrby(key="+key+", score="+score+", member="+member+",db="+db+") exception: "+e.toString(),e);
	...
	public Long zrank(String key, String member, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zrank(key="+key+", member="+member+",db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zrank(key="+key+", member="+member+",db="+db+") exception: "+e.toString(),e);
	...
	public Long zrevrank(String key, String member, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zrevrank(key="+key+", member="+member+",db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zrevrank(key="+key+", member="+member+",db="+db+") exception: "+e.toString(),e);
	...
	public Long zremrangeByRank(String key, long start, long end,int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zremrangeByRank(key="+key+", start="+start+", end="+end+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zremrangeByRank(key="+key+", start="+start+", end="+end+", db="+db+") exception: "+e.toString(),e);
	...
	public Set<String> zrange(String key, long start, long end, int db){
		...
		try{
			...
			flag = false;
			logger.error("redis call zrange(key="+key+", start="+start+", end="+end+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zrange(key="+key+", start="+start+", end="+end+", db="+db+") exception: "+e.toString(),e);
	...
	public Set<Tuple> zrangeWithScores(String key, long start, long end, int db) {
		...
		try{
			...
			flag = false;
			logger.error("redis call zrangeWithScores(key="+key+", start="+start+", end="+end+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call zrangeWithScores(key="+key+", start="+start+", end="+end+", db="+db+") exception: "+e.toString(),e);
	...
	public List<String> blpop(int db, int timeout, String... keys) {
		...
		try{
			...
			flag = false;
			logger.error("redis call blpop(timeout="+timeout+", keys="+keys+", db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call blpop(timeout="+timeout+", keys="+keys+", db="+db+") exception: "+e.toString(),e);
	...
	public Boolean hexists(String key, String member, int db) {
		...
		try{
			...
			flag = false;
			logger.error("redis call hexists(key="+key+", field="+member+"db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call hexists(key="+key+", field="+member+"db="+db+") exception: "+e.toString(),e);
	...
	@Override
	public Set<String> sdiff(int db, String... keys){
		Jedis jedis = builder.buildJedis(db);
		boolean flag = true;
		try{
			...
			flag = false;
			logger.error("redis call sdiff(keys="+keys+",db="+db+") exception: "+e.toString(),e);
			builder.returnBrokenResource(jedis);
		}catch(Exception e){
			flag = false;
			logger.error("redis call sdiff(keys="+keys+",db="+db+") exception: "+e.toString(),e);
